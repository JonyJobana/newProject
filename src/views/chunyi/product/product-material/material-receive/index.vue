...
<!--      </el-button>-->
    ...
    >
      ...
      <el-table-column label="生产订单号" width="150px" align="center">
...
<!--      <el-table-column label="单位" width="75px" align="center">-->
<!--        <template slot-scope="{row}">-->
<!--          <span>{{ row.author }}</span>-->
<!--        </template>-->
<!--      </el-table-column>-->
<!--      <el-table-column label="价格" width="75px" align="center">-->
<!--        <template slot-scope="{row}">-->
<!--          <span style="color:red;">{{ row.reviewer }}</span>-->
<!--        </template>-->
<!--      </el-table-column>-->
      <el-table-column label="发起时间" width="135px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.timestamp | parseTime('{y}-{m}-{d} {h}:{i}') }}</span>
          <!--          <svg-icon v-for="n in + row.importance" :key="n" icon-class="star" class="meta-item__icon" />-->
        </template>
      </el-table-column>
      <el-table-column label="发起人" align="center" width="80">
        <template slot-scope="{row}">
...
<!--          <el-input v-model="temp.title" :autosize="{ minRows: 2, maxRows: 4}"  placeholder="Please input" />-->
<!--        </el-form-item>-->
...
<!--        </el-form-item>-->
        ...
        <!--          &lt;!&ndash;          <el-rate v-model="temp.importance" :colors="['#99A9BF', '#F7BA2A', '#FF9900']" :max="3" style="margin-top:8px;" />&ndash;&gt;-->
        <!--        </el-form-item>-->
        <el-form-item label="发起日期" prop="importance">
    ...
    data() {
      return {
        ...
        rules: {
          ...
          importance: [{ required: true, message: 'title is required', trigger: 'blur' }],
        },
